...
![Equipment Demo](Assets/Documentation/Screenshots/Equipment/flashlight.jpg)
...
![Map Layout Top](Assets/Documentation/Screenshots/Map/Screenshot_2.jpg)
*Архитектура станции: видны основные узлы, переходы и зоны размещения дверей.*

### Пространственная перспектива
![Map Perspective](Assets/Documentation/Screenshots/Screenshot_3.jpg)
...
![Interactions](Assets/Documentation/Screenshots/Equipment/door.jpg)
*Визуализация зон триггеров для автоматических систем.*

### Рабочее окружение
![Development environment](Assets/Documentation/Screenshots/Equipment/tablet0.jpg)
